...
public class LoginPanel extends javax.swing.JPanel {
    ...
    public LoginPanel(JPanel pnlMain, JButton mniLogin, JButton mniRegister, JButton mniPlayQuiz, JButton mniChangePassword,
    ...
    private void login() {
        ...
        if (check) {
            boolean rs = userBll.check(username, password);
            if (rs) {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("User Login"));
